...
#include "keyboard/keylayouts.hpp" // Keymap2::keylayouts()
...
void config_spec_definition(Writer && W)
{
    ...
    W.section("globals", [&]
    {
        ...
        W.member(no_ini_no_gui, proxy_to_sesman, no_reset_back_to_selector, L, type_<std::string>(), names{.cpp="nla_auth_user", .sesman="nla_login"});
        W.member(no_ini_no_gui, sesman_rw, no_reset_back_to_selector, L, type_<std::string>(), names{.cpp="auth_user", .sesman="login"});
        W.member(no_ini_no_gui, sesman_rw, no_reset_back_to_selector, L, type_<std::string>(), names{.cpp="host", .sesman="ip_client"});
        W.member(no_ini_no_gui, proxy_to_sesman, no_reset_back_to_selector, L, type_<std::string>(), names{.cpp="target", .sesman="ip_target"});
        ...
        W.member(no_ini_no_gui, sesman_rw, reset_back_to_selector, L, type_<std::string>(), names{.cpp="target_user", .sesman="target_login"});
        ...
        W.member(ini_and_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<bool>(), names{"unicode_keyboard_event_support"}, set(true));
    ...
    W.section("client", [&]
    {
        ...
        for (auto const& k : keylayouts()) {
            keyboard_layout_proposals_desc += k.name;
    ...
    W.section(names{.cpp="mod_rdp", .connpolicy="rdp"}, [&]
    {
        ...
        W.member(advanced_in_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<bool>(), names{.cpp="bogus_sc_net_size", .sesman="rdp_bogus_sc_net_size"}, desc{"Needed to connect with VirtualBox, based on bogus TS_UD_SC_NET data block."}, set(true));
        ...
        W.member(hidden_in_gui, rdp_connpolicy | advanced_in_connpolicy, L, type_<bool>(), names{"enable_rdpdr_data_analysis"}, set(true));
        ...
        W.member(no_ini_no_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<bool>(), names{"enable_server_cert_external_validation"});
        W.member(no_ini_no_gui, proxy_to_sesman, no_reset_back_to_selector, L, type_<std::string>(), names{"server_cert"});
    ...
    W.section(names{.cpp="mod_vnc", .connpolicy="vnc"}, [&]
    {
        ...
        W.member(advanced_in_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<VncBogusClipboardInfiniteLoop>(), names{.cpp="bogus_clipboard_infinite_loop", .sesman="vnc_bogus_clipboard_infinite_loop"}, set(VncBogusClipboardInfiniteLoop::delayed));
    ...
    W.section("video", [&]
    {
        ...
        W.member(hidden_in_gui, sesman_to_proxy, reset_back_to_selector, L, type_<bool>(), names{"rt_display"}, set(false));
        ...
        W.member(advanced_in_gui, no_sesman, L, type_<types::range<types::unsigned_, 1, 120>>(), names{"framerate"}, set(5));
    ...
    W.section("context", [&]
    {
        ...
        W.member(no_ini_no_gui, proxy_to_sesman, no_reset_back_to_selector, L, type_<ColorDepth>(), names{.cpp="opt_bpp", .sesman="bpp"}, set(ColorDepth::depth24));
        W.member(no_ini_no_gui, proxy_to_sesman, no_reset_back_to_selector, L, type_<types::u16>(), names{.cpp="opt_height", .sesman="height"}, set(600));
        W.member(no_ini_no_gui, proxy_to_sesman, no_reset_back_to_selector, L, type_<types::u16>(), names{.cpp="opt_width", .sesman="width"}, set(800));
        ...
        W.member(no_ini_no_gui, sesman_to_proxy, reset_back_to_selector, L, type_<std::string>(), names{.cpp="target_protocol", .sesman="proto_dest"}, set("RDP"));
        ...
        W.member(no_ini_no_gui, sesman_to_proxy, reset_back_to_selector, L, type_<std::chrono::seconds>(), names{.cpp="end_date_cnx", .sesman="timeclose"}, set(0));
        ...
        W.member(no_ini_no_gui, proxy_to_sesman, no_reset_back_to_selector, L, type_<std::string>(), names{"session_probe_launch_error_message"});
