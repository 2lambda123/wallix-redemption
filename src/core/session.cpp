...
private:
    ...
    bool retry_rdp(
        SecondarySession & secondary_session, ErrorMessageCtx & err_msg_ctx, ModFactory & mod_factory,
            ...
            try {
                ...
                if (REDEMPTION_UNLIKELY(next_module != ModuleName::UNKNOWN)) {
                    ...
                    this->next_backend_module(
                        ...
                        secondary_session, err_msg_ctx, mod_factory, mod_wrapper,
                    ...
                    case EndSessionResult::close_box: {
                        ...
                        if (ini.get<cfg::globals::enable_close_box>()) {
                            if (!is_close_module(mod_wrapper.current_mod)) {
                                ...
                                this->next_backend_module(
                                    ModuleName::close, secondary_session, err_msg_ctx, mod_factory,
